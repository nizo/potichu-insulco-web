...
if ($atts['special_divider']['selected_value'] == 'text' || $atts['special_divider']['selected_value'] == 'icon') :
    ...
    if ($atts['width'] == '100') {
        $atts['width'] = 'auto';
        if ($atts['type'] != 'getleads-divider-space') {
            $atts['class'] .= ' getleads-divider-full-width';
        }
    }
    ...
    //getleads_print($show_bg);


    if ($type == 'icon') {
        $divider_icon_class = 'getleads-divider-icon';
    }
    ...
    ?>
    <div <?php echo esc_attr($link_id); ?> class="getleads-divider-special <?php echo esc_attr($atts['class']); ?> <?php echo esc_attr($atts['type']); ?> <?php echo esc_attr($size); ?> <?php echo esc_attr($position); ?> <?php echo esc_attr($divider_size); ?> <?php echo  $divider_bg_class; ?> <?php echo  $divider_icon_class; ?>" <?php echo 'style="width:' . esc_attr($atts['width']) . '%; ' . $custom_spacing . '"'; ?> >
        <div class="getleads-divider-inner <?php echo esc_attr($divider_inner_class); ?>" style="<?php echo  $special_bg_color; ?>">
            <span class="getleads-divider-holder getleads-divider-left <?php echo esc_attr($border_class); ?>" style="<?php echo  $bg_color; ?>"></span>
            <span class="getleads-divider-title <?php echo esc_attr($divider_title_class); ?>" style="<?php echo  $text_icon_color; ?>">
                <?php if ($type == 'icon') : ?>
                    <i class="<?php echo  $atts['special_divider']['icon']['icon_class']; ?>"></i>
                <?php else : ?>
                    <?php echo getleads_theme_translate(esc_attr($atts['special_divider']['text']['title_text'])); ?>
                <?php endif; ?>
            </span>
            <span class="getleads-divider-holder getleads-divider-right <?php echo esc_attr($border_class); ?>" style="<?php echo  $bg_color; ?>"></span>
        </div>
    </div>
    <?php
else:
    ...
    if ($atts['type'] == 'getleads-divider-space') {
        ...
        $line_class = 'getleads-divider-line';
    }
    ?>
