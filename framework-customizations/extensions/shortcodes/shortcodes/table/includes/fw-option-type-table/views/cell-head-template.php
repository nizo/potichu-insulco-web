...
<?php foreach ( $option['columns_options'] as $id => $options ) : ?>
	...
	<?php echo getleads()->backend->option_type( $options['type'] )->render( $id, $options, $data_cols ); ?>

<?php endforeach; ?>

<a href="#" class="getleads-table-add-column button button-large">
	<span class="text"><?php echo __( 'Add Column', 'getleads' ) ?></span>
